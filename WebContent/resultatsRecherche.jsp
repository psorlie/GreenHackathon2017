			  ...
			  <!-- CONTENU PAGE ICI -->
				<div class="card mb-3">
					<div class="card-header">
						<i class="fa fa-search"></i> <strong>Dentistes trouves :</strong></div>
						<div class="card-body">
							...
							<table class="table table-hover">
							    ...
							    <tbody>
							    	<% for(int i=0; i<nbResultats; ++i){ %>
							    		<tr>
							        		<td>photo</td>
							       	 		<% if(dentistes[i].isFemale()) {%>
							       	 			<td>Mme. <%= dentistes[i].getSurname() + " " + dentistes[i].getFirstName()%></td>
							       	 		<% } else { %>
							       	 			<td>M. <%= dentistes[i].getSurname() + " " + dentistes[i].getFirstName()%></td>
							       	 		<%} %>
							      		</tr>
							    	<% } %>
